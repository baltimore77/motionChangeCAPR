...
jsPsych.plugins["rdk-change"] = (function() {
		    ...
		    border_color: {
		      ...
		      description: "The color of the border"
				...
				coherence_duration: {
					...
					default: 500, //should be same as trial_duraion if no change
					description: "How long the coherent dots flow prior to a change, in the event of a change in coherent direction"
				},
				coherence_change: {
					type: jsPsych.plugins.parameterType.BOOL,
					pretty_name: "Coherence change",
					default: true,
					description: "Whether or not a change in dot coherence occurs"
				},
				change_trial_degrees_changed: {
					type: jsPsych.plugins.parameterType.INT,
					pretty_name: "Coherence change in degrees",
					default: 90,
					description: "If a change occured among coherent dots, how many degrees was the change"
				},
	...
	plugin.trial = function(display_element, trial) {
		...
		*/
		...
		//Change trial additions:
		var coherentChangedJumpSizeX;
		var coherentChangedJumpSizeY;
...
//			console.log(angleInRadians)
		...
		function makeDotArray2d(periodBeforeCoherenceChange) {
			...
			for (var i = 0; i < nSets; i++) {
				//Change trial additions:
				tempArray.push(makeDotArray(periodBeforeCoherenceChange)); //Make a dot array and push it into the 2d array
			}
